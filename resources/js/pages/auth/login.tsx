    ...
    return (
        <>
            ...
            <div className="mt-6 rounded-2xl border border-[#dfe5e1] bg-[#f8faf8] p-4">
                <p className="text-[10px] font-bold tracking-[0.08em] text-[#839089] uppercase">MVP demo account</p>
                <p className="mt-1.5 text-xs leading-5 text-[#64736c]">The support-worker credentials are pre-filled. Select “Sign in securely” to explore the care workflow.</p>
            </div>
        </>
    );
}
